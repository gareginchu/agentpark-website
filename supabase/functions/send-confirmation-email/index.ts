...
serve(async (req) => {
  ...
  try {
    ...
    function formatDateAm(): string {
      ...
      let d = dt.getFullYear() + "\u0569. " + amMonths[dt.getMonth()] + " " + dt.getDate() + "-\u056B\u0576";
      if (event.start_time) {
        d += ", " + event.start_time + (event.end_time ? "\u2013" + event.end_time : "");
      }
      return d;
      ...
      return `
        <div style="${sectionStyle}">
          ...
          <div style="text-align: center; margin-top: 16px;">
            ...
            <a href="https://agentpark-website.pages.dev"><img src="https://agentpark-website.pages.dev/Brand_assets/AgentPark_logo_email.jpg" alt="AgentPark" width="130" height="72" style="height: 72px; width: 130px; margin-top: 8px; border: 0;"></a>
          </div>
        </div>
        <div style="${cardStyle}">
    ...
    const amSection = buildSection({
      ...
      meetingLabel: "\u0544\u056B\u0561\u0576\u0561\u056C \u0574\u056B\u057B\u0578\u0581\u0561\u057C\u0574\u0561\u0576\u0568 \u0561\u057C\u0581\u0561\u0576\u0581",
